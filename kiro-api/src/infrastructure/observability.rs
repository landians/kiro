    ...
    pub fn new(meter: Meter) -> Self {
        Self {
            requests_total: meter
                .u64_counter("kiro_http_server_requests_total")
                .with_description("Total number of HTTP requests received by the server.")
                .build(),
            responses_total: meter
                .u64_counter("kiro_http_server_responses_total")
                .with_description("Total number of HTTP responses sent by the server.")
                .build(),
            request_duration_ms: meter
                .f64_histogram("kiro_http_server_request_duration_ms")
                .with_description("HTTP request duration in milliseconds.")
                .build(),
            request_body_size_bytes: meter
                .u64_histogram("kiro_http_server_request_body_size_bytes")
                .with_description("HTTP request body size in bytes.")
                .build(),
            response_body_size_bytes: meter
                .u64_histogram("kiro_http_server_response_body_size_bytes")
